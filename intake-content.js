...
const FIELDS = {
  ...
  'f-diet': { t: 'textarea',
    ...
    ph: ['e.g. Breakfast: skip, just coffee. Lunch: chicken rice bowl. Dinner: beef and two veg, rice. Snacks: chips, one apple. Drinks: 2 coffees, some Coke. The more you name the actual foods and rough portions, the closer the protein and nutrient estimate gets.',
         '例如：早餐不吃，只喝咖啡。午餐一碗鸡肉饭。晚餐牛肉配两个菜加米饭。零食薯片、一个苹果。喝的：两杯咖啡、一点可乐。你把具体吃了什么、大概多少写得越清楚，蛋白质和营养素的估算就越准。',
         'p. ej. Desayuno: lo omito, solo café. Comida: pollo con arroz. Cena: carne, dos verduras y arroz. Snacks: papas fritas, una manzana. Bebidas: 2 cafés, algo de refresco. Cuanto más nombre los alimentos y las porciones aproximadas, más se acerca la estimación.',
         'उदा. नाश्ता: छोड़ देता हूँ, बस कॉफ़ी। दोपहर: चिकन राइस। रात: बीफ़, दो सब्ज़ियाँ, चावल। स्नैक्स: चिप्स, एक सेब। पेय: 2 कॉफ़ी, थोड़ा कोक। आप जितना असली भोजन और मात्रा बताएँगे, अनुमान उतना सटीक होगा।'],
    h: ['This is the answer the protein and nutrient estimate is built from, which is why it is a box and not a dropdown. Your protein requirement is your body weight in kilograms times 1.2 grams, and the only way to know whether you are meeting it is to see what you actually eat. Naming the foods and rough portions is what makes the number real rather than a guess.',
        '蛋白质和营养素的估算就是从这一题算出来的，所以它是文本框而不是下拉。你的蛋白质需要量是体重（公斤）乘以1.2克，而要知道你有没有吃够，只能看你实际吃了什么。写清楚吃了什么、大概多少，这个数字才是算出来的而不是猜的。',
        'De esta respuesta se construye la estimación de proteína y nutrientes, por eso es un cuadro y no un desplegable. Su requerimiento de proteína es su peso en kilogramos por 1,2 gramos, y la única forma de saber si lo cumple es ver qué come en realidad.',
        'प्रोटीन और पोषक तत्वों का अनुमान इसी उत्तर से बनता है, इसीलिए यह बॉक्स है, ड्रॉपडाउन नहीं। आपकी प्रोटीन आवश्यकता आपके वज़न (किग्रा) × 1.2 ग्राम है, और यह जानने का एकमात्र तरीका है कि आप वास्तव में क्या खाते हैं।'] },
